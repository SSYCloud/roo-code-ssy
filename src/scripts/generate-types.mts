...
async function main() {
	const types: string[] = [
		"// This file is automatically generated by running `pnpm --filter roo-vibecoding generate-types`\n// Do not edit it directly.",
	]
	...
	fs.copyFileSync("out/interface.d.ts", "exports/roo-vibecoding.d.ts")

	await $`npx prettier --write exports/types.ts exports/roo-vibecoding.d.ts`
